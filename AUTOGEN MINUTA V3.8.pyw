...
class App(ctk.CTk, TkinterDnD.DnDWrapper):
    def __init__(self, *args, **kwargs):
        ...
        ctk.CTkLabel(self.main_frame, text="Nome do Cliente:").grid(row=0, column=0, padx=10, pady=(10, 5), sticky="w")
        self.destination_entry = ctk.CTkEntry(self.main_frame, placeholder_text="Ex: Cliente")
        self.destination_entry.grid(row=0, column=1, padx=10, pady=(10, 5), sticky="ew")

        ctk.CTkLabel(self.main_frame, text="Nº Doc.Saída ou NF:").grid(row=1, column=0, padx=10, pady=5, sticky="w")
        self.order_entry = ctk.CTkEntry(self.main_frame, placeholder_text="9999 ou NF 9.999")
        self.order_entry.grid(row=1, column=1, padx=10, pady=5, sticky="ew")
    ...
    def show_changelog(self, event=None):
        if self.changelog_window is None or not self.changelog_window.winfo_exists():
            ...
            self.changelog_window.grid_rowconfigure(0, weight=1)
